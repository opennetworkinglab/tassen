...
var mockFieldMatch1 = p4v1.FieldMatch{
	FieldId: 1,
...
var mockFieldMatch2 = p4v1.FieldMatch{
	FieldId: 2,
	FieldMatchType: &p4v1.FieldMatch_Exact_{
		Exact: &p4v1.FieldMatch_Exact{
			Value: []byte{0x02},
...
var mockFieldMatch3 = p4v1.FieldMatch{
	FieldId: 3,
	FieldMatchType: &p4v1.FieldMatch_Exact_{
		Exact: &p4v1.FieldMatch_Exact{
			Value: []byte{0x03},
...
var mockFieldMatch4 = p4v1.FieldMatch{
	FieldId: 4,
	FieldMatchType: &p4v1.FieldMatch_Exact_{
		Exact: &p4v1.FieldMatch_Exact{
			Value: []byte{0x04},
...
var mockTableAction1 = p4v1.TableAction{
	Type: &p4v1.TableAction_Action{Action: &p4v1.Action{
		ActionId: 1,
...
var mockTableAction2 = p4v1.TableAction{
	Type: &p4v1.TableAction_Action{Action: &p4v1.Action{
		ActionId: 1,
		Params: []*p4v1.Action_Param{
...
var mockTableEntry1 = p4v1.TableEntry{
	TableId:  1,
	Match:    []*p4v1.FieldMatch{&mockFieldMatch1, &mockFieldMatch2},
...
var sameAsMockTableEntry1 = p4v1.TableEntry{
	TableId:  1,
	Match:    []*p4v1.FieldMatch{&mockFieldMatch1, &mockFieldMatch2},
	Action:   &mockTableAction1,
	Priority: 1,
...
var mockTableEntry2 = p4v1.TableEntry{
	TableId:  2,
	Match:    []*p4v1.FieldMatch{&mockFieldMatch3, &mockFieldMatch4},
...
func Test_store_FilterTableEntries(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:   "empty",
			fields: fields{map[string]*p4v1.TableEntry{ /* empty */ }},
			args: args{f: func(e *p4v1.TableEntry) bool {
				return e.TableId == 1
			}},
			want: []*p4v1.TableEntry{ /* empty */ },
		},
		{
			name: "get 1",
			fields: fields{map[string]*p4v1.TableEntry{
...
func Test_store_PutTableEntry(t *testing.T) {
	...
	tests := []struct {
		...
		{"empty", fields{map[string]*p4v1.TableEntry{
			// empty
		}}, args{&mockTableEntry1}, 1},
		{"existing key", fields{map[string]*p4v1.TableEntry{
			mockTableEntryKey1: &mockTableEntry1,
		}}, args{&sameAsMockTableEntry1}, 1},
		{"new key", fields{map[string]*p4v1.TableEntry{
			mockTableEntryKey1: &mockTableEntry1,
...
func Test_store_GetTableEntry(t *testing.T) {
	...
	tests := []struct {
		...
		{"non existing key", fields{map[string]*p4v1.TableEntry{
			mockTableEntryKey1: &mockTableEntry1,
...
func Test_store_TableEntries(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "empty", fields: fields{map[string]*p4v1.TableEntry{
				// empty
		}}, want: []*p4v1.TableEntry{
			// empty
		}},
		{name: "1 entry", fields: fields{map[string]*p4v1.TableEntry{
			mockTableEntryKey1: &mockTableEntry1,
		}}, want: []*p4v1.TableEntry{
			&mockTableEntry1,
		}},
		{name: "2 entries", fields: fields{map[string]*p4v1.TableEntry{
			mockTableEntryKey1: &mockTableEntry1,
			mockTableEntryKey2: &mockTableEntry2,
		}}, want: []*p4v1.TableEntry{
			&mockTableEntry1,
...
func Test_store_TableEntryCount(t *testing.T) {
	...
	tests := []struct {
		...
		{"1 entry", fields{map[string]*p4v1.TableEntry{
			mockTableEntryKey1: &mockTableEntry1,
		}}, 1},
		{"2 entries", fields{map[string]*p4v1.TableEntry{
			mockTableEntryKey1: &mockTableEntry1,
			mockTableEntryKey2: &mockTableEntry2,
		}}, 2},
	}
