...
class PppoeIp4UnicastTest(P4RuntimeTest):
    ...
    def testPacket(self, pkt):
        ...
        self.insert(self.helper.build_act_prof_group(
            ...
            group_id=line_id,
            actions=[
                ('IngressPipe.downstream.route_pppoe_v4',
...
class IpoeIp4UnicastTest(P4RuntimeTest):
    """Tests downstream IPoE aggregation and routing of IPv4 unicast packets.
    """
    ...
    def testPacket(self, pkt):
        ...
        self.insert(self.helper.build_act_prof_group(
            ...
            group_id=line_id,
            actions=[
                ('IngressPipe.downstream.route_ipoe_v4',
                    {'dmac': next_hop_mac, 'port': self.port2}),
            ]
        ))
        ...
        # Expected pkt should have vlan tags, IP header, routed MAC addresses
        # and decremented TTL.
        exp_pkt = pkt.copy()
        exp_pkt = pkt_add_vlan(exp_pkt, vid=c_tag)
        exp_pkt = pkt_add_vlan(exp_pkt, vid=s_tag)
